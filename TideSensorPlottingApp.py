    ...
    def run(self):
        ...
        while self.running:
            if ser.in_waiting > 0:
                ...
                self.message_received.emit(decoded_line)
...
class MainWindow(QMainWindow):
    ...
    def update_plot(self, frame=None):
        ...
        data = self.data[-10000:]  # Limit data to the last 10000 points
        ...
        self.axs[0, 0].set_ylim(500, max(1200, df['Ultrasonic Range'].max()))
...
if __name__ == "__main__":
    ...
    window = MainWindow()
    window.show()
    sys.exit(app.exec_())  # Note the underscore after exec